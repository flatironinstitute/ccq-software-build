...
BUILDDIR="/dev/shm/vasp_build_632_nixpack_gnu"
mkdir -p ${BUILDDIR}
INSTALLDIR="$(pwd)"
...
echo '#%Module' > $MODULEDIR/vasp/6.3.2_gnu
# update module template
sed "s|REPLACEDIR|${INSTALLDIR}|g;s|MODULES|${MODULES}|g" < src.module >> $MODULEDIR/vasp/6.3.2_gnu
