...
export CXXFLAGS="-stdlib=libc++ -Wno-register -march=znver2"
...
(
    ...
    git clone -b DLR2D --depth 1 https://github.com/TRIQS/triqs triqs.src
    ...
    git clone -b DLR2D --depth 1 https://github.com/TRIQS/cthyb cthyb.src
    ...
    git clone -b DLR2D --depth 1 git@github.com:TRIQS/ctseg.git ctseg.src
