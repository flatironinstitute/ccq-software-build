...
BUILDINFO=3_modest_nix2.4_llvm
...
(
    ...
    echo "[$(date +%H:%M:%S)] Building triqs (modest_updates branch)..." >&3
    git clone -b modest_updates --depth 1 https://github.com/TRIQS/triqs triqs.src
