...
# installation script for triqs3 3.3.x branch with clang OpenMPI toolchain (nix2.4 modules)
...
(
    ...
    git clone -b 3.3.x --depth 1 https://github.com/TRIQS/triqs triqs.src
    ...
    git clone -b 3.3.x --depth 1 https://github.com/TRIQS/cthyb cthyb.src
    ...
    git clone -b 3.3.x --depth 1 https://github.com/TRIQS/dft_tools.git dft_tools.src
    ...
    git clone -b 3.3.x --depth 1 https://github.com/TRIQS/maxent.git maxent.src
    ...
    git clone -b 3.3.x --depth 1 https://github.com/TRIQS/Nevanlinna.git Nevanlinna.src
    ...
    git clone -b 3.3.x --depth 1 https://github.com/TRIQS/tprf.git tprf.src
    ...
    git clone -b 3.3.x --depth 1 https://github.com/TRIQS/hubbardI.git hubbardI.src
    ...
    git clone -b 3.3.x --depth 1 https://github.com/triqs/hartree_fock.git hartree_fock.src
    ...
    git clone -b 3.3.x --depth 1 https://github.com/flatironinstitute/solid_dmft.git solid_dmft.src
