...
module purge
module load slurm 
module load /mnt/home/ahampel/git/ccq-software-build/triqs/3_stable_llvm_ompi/module-skylake
...
mpirun --map-by node:pe=$OMP_NUM_THREADS python3 yourscript.py
