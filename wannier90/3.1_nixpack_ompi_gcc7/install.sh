...
# load modules
MODULES="gcc/7 openmpi/4 fftw intel-oneapi-mkl python/3.9"
module purge
module load ${MODULES}

BUILDDIR="/dev/shm/w90_build_31_nixpack_ompi_gcc7"
mkdir -p ${BUILDDIR}
INSTALLDIR="$(pwd)"
...
echo '#%Module' > ../../modules/wannier90/3.1_gnu_ompi_gcc7
# update module template
sed "s|REPLACEDIR|${INSTALLDIR}|g;s|MODULES|${MODULES}|g" < src.module >> ../../modules/wannier90/3.1_gnu_ompi_gcc7
