...
(
    ...
    git clone -b qe-7.0 https://github.com/QEF/q-e.git qe
    cd qe
...
echo '#%Module' > ../../modules/quantum_espresso/7.0_gnu_ompi
# update module template
sed "s|REPLACEDIR|${INSTALLDIR}|g;s|MODULES|${MODULES}|g" < src.module >> ../../modules/quantum_espresso/7.0_gnu_ompi
