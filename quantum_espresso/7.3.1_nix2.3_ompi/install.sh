...
# load modules
MODULES="modules/2.3-20240529 gcc openmpi/4 fftw intel-oneapi-mkl hdf5/mpi git libxc wannier90/dev_nix2.3_gnu_ompi cmake"
module purge
module load ${MODULES}

export FFLAGS="-O3 -g -march=broadwell"

BUILDINFO=7.3.1_nix2.3_gnu_ompi
